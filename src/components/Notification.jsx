...
const Notification = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-10 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 drop-shadow-lg">
      ...
      <div className="mt-5 ">
          <div className="flex items-center leading-8 gap-5 border-b-1 border-color p-3">
            <img className="rounded-full h-10 w-10" alt='message' />
            <div>
